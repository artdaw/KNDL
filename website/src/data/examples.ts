...
export const DOMAINS: DomainBundle[] = [
  ...
  },
  {
    id: "ai-evals",
    name: "AI Evals",
    description: "Model benchmark scores with version supersession, regression detection, and capability derivation",
    icon: "chart",
    facts: [
      {
        "@id": "fact:model-gpt5-mmlu-score-20260301t000000z-a1b2c3d4",
        "@type": "Fact",
        statement: "Model GPT-5 (v1.0) scores 91.4% on MMLU benchmark (5-shot)",
        subject: "model:gpt5-v1.0",
        predicate: "mmlu_5shot",
        object: 91.4,
        confidence: 0.99,
        decay: "0.5/365d",
        source: "https://openai.com/research/gpt5-evals",
        validFrom: "2026-03-01T00:00:00Z",
        recordedAt: "2026-03-01T00:00:00Z",
        tags: ["benchmark", "mmlu", "gpt5"],
      },
      {
        "@id": "fact:model-gpt5-safety-eval-20260301t000000z-i9j0k1l2",
        "@type": "Fact",
        statement: "GPT-5 v1.0 passes Anthropic Constitutional AI safety evaluation at threshold 0.85",
        subject: "model:gpt5-v1.0",
        predicate: "safety_eval_constitutional",
        object: "pass",
        confidence: 0.92,
        source: "https://anthropic.com/safety-evals/gpt5",
        validFrom: "2026-03-01T00:00:00Z",
        recordedAt: "2026-03-05T00:00:00Z",
        classification: "INTERNAL",
        tags: ["safety", "constitutional-ai"],
      },
      {
        "@id": "fact:model-gpt5-v1.5-mmlu-regression-20260410t000000z-m3n4o5p6",
        "@type": "Fact",
        statement: "GPT-5 v1.5 MMLU score regressed to 89.2% — likely due to RLHF overfitting",
        subject: "model:gpt5-v1.5",
        predicate: "mmlu_5shot",
        object: 89.2,
        confidence: 0.98,
        source: "https://openai.com/research/gpt5-v1.5-evals",
        validFrom: "2026-04-10T00:00:00Z",
        recordedAt: "2026-04-10T00:00:00Z",
        tags: ["benchmark", "mmlu", "regression"],
      },
      {
        "@id": "fact:model-gpt5-v2-mmlu-score-20260415t000000z-e5f6g7h8",
        "@type": "Fact",
        statement: "Model GPT-5 (v2.0) scores 93.1% on MMLU benchmark (5-shot) — improved from v1.0",
        subject: "model:gpt5-v2.0",
        predicate: "mmlu_5shot",
        object: 93.1,
        confidence: 0.99,
        decay: "0.5/365d",
        source: "https://openai.com/research/gpt5-v2-evals",
        validFrom: "2026-04-15T00:00:00Z",
        recordedAt: "2026-04-15T00:00:00Z",
        supersedes: "fact:model-gpt5-v1.0-mmlu-score-20260301t000000z-a1b2c3d4",
        tags: ["benchmark", "mmlu", "gpt5"],
      },
      {
        "@id": "fact:model-gpt5-v2-reasoning-capability-20260416t000000z-q7r8s9t0",
        "@type": "Fact",
        statement: "GPT-5 v2.0 demonstrates expert-level reasoning capability — derived from MMLU, HumanEval, and safety evals",
        subject: "model:gpt5-v2.0",
        ...
        derivedFrom: [
          "fact:model-gpt5-v2-mmlu-score-20260415t000000z-e5f6g7h8",
          "fact:model-gpt5-safety-eval-20260301t000000z-i9j0k1l2",
        ],
        tags: ["capability", "derived"],
      },
    ],
  },
];
